...
<br/>
    ...
    <div class="texte-au-dessus-de-ligne">
      <p>L\'inauguration de L\'Arc de triomphe</p>
      <div class="ligne3"></div>
    </div>
    <div class="Champs-Info3"></div>
    <div class="sousTitre">
      <h2>Une inauguration discrète</h2>
    </div>
    <div class="center-text2">
      <p>Le 29 juillet 1836 marque l\'inauguration de l\'Arc de Triomphe après trois décennies de travaux. Les listes de noms gravés sur les piédroits sont dévoilées lors de la cérémonie, mais la grande fête prévue est annulée par crainte d\'attentat contre le roi Louis-Philippe. Seulement onze personnes assistent à l\'événement, dont le président du Conseil des ministres Adolphe Thiers et le ministre des Finances Antoine Maurice Appolinaire Argout.</p>
    </div>
    <div class="center-text2">
      <p>À la nuit tombée, une foule se rassemble devant l\'Arc de Triomphe illuminé de 700 becs de gaz. Cependant, des controverses surgissent concernant les noms inscrits sur les piliers, entraînant des protestations. En réponse, le gouvernement et l\'architecte promettent d\'étudier toutes les demandes. L\'architecte Blouet ajoute rapidement 128 noms de généraux et 172 batailles oubliés. Dans son ouvrage de 1837 intitulé "Les Voix Intérieures", Victor Hugo exprimera son chagrin de ne pas voir le nom de son père, Jospeh-Léopold-Sigisbert Hugo, nommé général par Louis XVIII en 1814, figurant sur l\'Arc.</p>
    </div>
    <div class="center-text2">
      <p>Des ajouts ponctuels aux noms gravés sur l\'Arc de Triomphe se poursuivent jusqu\'en 1895, reflétant ainsi une histoire complexe et dynamique liée à ce monument emblématique de Paris.</p>
    </div>
    <br>
    <br>
    <div class="texte-au-dessus-de-ligne">
  ...
  <div class="center-text0">
    <p>Built to celebrate Napoleon Bonaparte\'s military victories, it stands at the end of the Champs-Élysées avenue.</p>
  </div>
  <div class="center-text0">
    <p>Its imposing design and commemorative bas-reliefs make it a powerful symbol of French national glory and grandeur.</p>
  </div>
  <br>
  <div class="titre-gauche">
    <span class="gros2">The history of the Arc de Triomphe</span>
  </div>
  <div class="texte-au-dessus-de-ligne">
    <p>The Napoleonic project</p>
    <div class="ligne3"></div>
  </div>
  <br>
  <div class="Champs-Info2"></div>
  ...
  <div class="center-text">
    <p>The construction process was not without its challenges, particularly at the time of the marriage of Napoleon 1st and Marie-Louise of Austria in 1810. Although the imperial itinerary planned to pass through the Place de l\'Étoile, the Arc de Triomphe construction site had not been completed. To compensate for this, a life-size mock-up was erected from painted canvas and framework. This temporary construction, costing 511,000 francs, allowed Chalgrin to make adjustments to the original plans, influencing in particular the projections, the removal of the plinths, and the choice of ornamentation for the façades.</p>
  </div>
  <div class="center-text">
    <p>However, in January 1811, Chalgrin died with the pillars of the Arc de Triomphe at a modest height. His pupil, Louis-Robert Goust, took over the project. Despite the challenges, these events shaped the construction of the Arc de Triomphe, revealing the ingenuity of the architects and illustrating perseverance in the face of obstacles.</p>
  </div>
  <div class="titre-gauche"></div>
  <div class="sousTitre">
    <h2>A building site suspended under Louis XVIII</h2>
  </div>
  <div class="center-text">
    <p></p>
  </div>
  <div class="center-text">
    <p>After the fall of Napoleon and the accession of Louis XVIII, work on the Arc de Triomphe was interrupted. In 1814, the architect Bernard Poyet even proposed demolishing the existing pillars, but this suggestion was rejected by Louis XVIII, although no intention to resume construction was clearly expressed. The monarchists criticised this project commissioned by Napoleon, and various alternative proposals between 1814 and 1823 failed to arouse any royal interest.</p>
  </div>
  <div class="center-text">
  ...
  <div class="Champs-Info3"></div>
  <div class="sousTitre">
    <h2>A discreet inauguration</h2>
  </div>
  <div class="center-text2">
    <p>The Arc de Triomphe was inaugurated on 29 July 1836 after three decades of construction work. The lists of names engraved on the pedestals were unveiled at the ceremony, but the planned grand celebration was cancelled for fear of an assassination attempt on King Louis-Philippe. Only eleven people attended the event, including the President of the Council of Ministers Adolphe Thiers and the Minister of Finance Antoine Maurice Appolinaire Argout.</p>
  </div>
  <div class="center-text2">
    <p>As night fell, crowds gathered in front of the Arc de Triomphe, illuminated by 700 gaslights. However, controversy arose over the names inscribed on the pillars, leading to protests. In response, the government and the architect promised to consider all requests. Architect Blouet quickly added 128 names of generals and 172 forgotten battles. In his 1837 book "Les Voix Intérieures", Victor Hugo expressed his chagrin at not seeing the name of his father, Jospeh-Léopold-Sigisbert Hugo, appointed general by Louis XVIII in 1814, appear on the Arc.</p>
  </div>
  <div class="center-text2">
    <p> Occasional additions to the names engraved on the Arc de Triomphe continued until 1895, reflecting the complex and dynamic history of this iconic Paris monument.</p>
  </div>
  <br>
  <br>
  <div class="texte-au-dessus-de-ligne">
